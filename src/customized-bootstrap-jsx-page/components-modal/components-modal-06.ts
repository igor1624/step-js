...
import Modal06 from "./modal-06.jsx";
import {ScrollablePanel} from "@step-js-custom/index";

class ComponentsModal06 extends ScrollablePanel {
  parentDIV: DIV;
  ...
  mount() {
    ...
    new H4("Modal / Permission required", cardHeader);
    const a = new A({
    ...
    a.setInnerText("/ jsx / modals / modal-6");
...
export default ComponentsModal06;
