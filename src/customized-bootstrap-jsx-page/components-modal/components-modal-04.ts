...
import Modal04 from "./modal-04.jsx";
import {ScrollablePanel} from "@step-js-custom/index";

class ComponentsModal04 extends ScrollablePanel {
  parentDIV: DIV;
  ...
  mount() {
    ...
    new H4("Modal / Archive project", cardHeader);
    const a = new A({
    ...
    a.setInnerText("/ jsx / modals / modal-4");
...
export default ComponentsModal04;
