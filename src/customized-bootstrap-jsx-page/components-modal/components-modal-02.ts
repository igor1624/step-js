...
import Modal02 from "./modal-02.jsx";
import {ScrollablePanel} from "@step-js-custom/index";

class ComponentsModal02 extends ScrollablePanel {
  parentDIV: DIV;
  ...
  mount() {
    ...
    a.setInnerText("/ jsx / modals / modal-2");
...
export default ComponentsModal02;
