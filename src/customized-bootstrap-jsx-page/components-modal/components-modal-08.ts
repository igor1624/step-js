...
import Modal08 from "./modal-08.jsx";
import {ScrollablePanel} from "@step-js-custom/index";

class ComponentsModal08 extends ScrollablePanel {
  parentDIV: DIV;
  ...
  mount() {
    ...
    new H4("Modal / Picture shared", cardHeader);
    const a = new A({
    ...
    a.setInnerText("/ jsx / modals / modal-8");
...
export default ComponentsModal08;
