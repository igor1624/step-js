...
import Modal05 from "./modal-05.jsx";
import {ScrollablePanel} from "@step-js-custom/index";

class ComponentsModal05 extends ScrollablePanel {
  parentDIV: DIV;
  ...
  mount() {
    ...
    new H4("Modal / Storage plan", cardHeader);
    const a = new A({
    ...
    a.setInnerText("/ jsx / modals / modal-5");
...
export default ComponentsModal05;
